...
if os.path.isfile('json/participation.json'):
    ...
    data = requests.get("https://api.github.com/repos/torvalds/linux/stats/participation").json()
...
if os.path.isfile('json/workinghour.json'):
    ...
    data = requests.get("https://api.github.com/repos/torvalds/linux/stats/punch_card").json()
...
def getLanguages(repos, index):
    ...
    if os.path.isfile('json/'+repos[index]["name"]+'.json'):
        ...
        languages = requests.get("https://api.github.com/repos/torvalds/" + repos[index]["name"] + "/languages").json()
